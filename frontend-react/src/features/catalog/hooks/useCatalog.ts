...
export const useCatalog = (entity: CatalogEntity, search: string, enabled = true) => useQuery({ queryKey: ['catalog', entity, search], queryFn: () => catalogService.list(entity, search), enabled })
