...
export type HomeFeature = { icon: string; title: string; description: string; isActive?: boolean }
export type HomeSettings = { hero: { title: string; subtitle: string; ctaText: string; ctaLink: string; bgImageUrl: string | null }; features: HomeFeature[] }
