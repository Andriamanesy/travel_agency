const translations = {
    fr: {
        ...
        "modal.p2": "TravelMS s'engage à vous fournir une plateforme sécurisée pour la gestion de vos réservations et voyages. Vos données personnelles sont traitées conformément aux normes de sécurité en vigueur.",
    ...
    en: {
        ...
        "register.submit": "Create account and travel",
        ...
        "modal.p1": "Welcome to TravelMS. By creating an account, you agree to comply with the terms and conditions below.",
        "modal.h1": "1. Use of Service",
        "modal.p2": "TravelMS is committed to providing a secure platform for managing your bookings.",
        "modal.h2": "2. User Account",
        "modal.p3": "You are responsible for maintaining the confidentiality of your password.",
        "modal.h3": "3. Data Protection",
        "modal.p4": "Collected data is used strictly for platform operation.",
    ...
    es: {
        ...
        "register.submit": "Crear cuenta y viajar",
        ...
        "register.error_match": "Las contraseñas no coinciden.",
        "register.error_default": "Ocurrió un error durante el registro.",
        "modal.title": "Términos de Servicio",
        "modal.p1": "Bienvenido a TravelMS. Al crear una cuenta, aceptas cumplir con los términos y condiciones.",
        "modal.h1": "1. Uso del Servicio",
        "modal.p2": "TravelMS se compromete a proporcionar una plataforma segura.",
        "modal.h2": "2. Cuenta de Usuario",
        "modal.p3": "Eres responsable de mantener la confidencialidad de tu contraseña.",
        "modal.h3": "3. Protección de Datos",
        "modal.p4": "Los datos recopilados se utilizan estrictamente para el funcionamiento.",
        "modal.btn": "Entiendo y acepto",
    ...
    ru: {
        ...
        "register.security": "🔒 Ваши данные защищены в безопасности.",
        "register.has_account": "Уже есть аккаунт?",
        "register.success_msg": "Аккаунт успешно создан! Перенаправление...",
        "register.error_match": "Пароли не совпадают.",
        "register.error_default": "Произошла ошибка при регистрации.",
        "modal.title": "Условия обслуживания",
        "modal.p1": "Добро пожаловать в TravelMS. Создавая аккаунт, вы соглашаетесь с условиями.",
        "modal.h1": "1. Использование сервиса",
        "modal.p2": "TravelMS обязуется предоставлять безопасную платформу.",
        "modal.h2": "2. Аккаунт пользователя",
        "modal.p3": "Вы несете ответственность за конфиденциальность пароля.",
        "modal.h3": "3. Защита данных",
        "modal.p4": "Собранные данные используются исключительно для работы платформы.",
        "modal.btn": "Я понимаю и принимаю",
    ...
    it: {
        ...
        "register.submit": "Crea account e viaggia",
        ...
        "register.error_match": "Le password non coincidono.",
        "register.error_default": "Si è verificato un errore durante la registrazione.",
        "modal.title": "Termini di Servizio",
        "modal.p1": "Benvenuto su TravelMS. Creando un account accetti i termini di servizio.",
        "modal.h1": "1. Uso del servizio",
        "modal.p2": "TravelMS si impegna a fornire una piattaforma sicura.",
        "modal.h2": "2. Account utente",
        "modal.p3": "Sei responsabile della riservatezza della tua password.",
        "modal.h3": "3. Protezione dei dati",
        "modal.p4": "I dati raccolti vengono utilizzati rigorosamente per il servizio.",
    ...
    zh: {
        ...
        "register.terms_suffix": "和隐私政策。",
        "register.submit": "创建账号并开启旅行",
        "register.submitting": "正在创建...",
        "register.security": "🔒 您的数据受到保护与安全加密。",
        "register.has_account": "已有账号？",
        "register.success_msg": "账号创建成功！正在重定向...",
        "register.error_match": "两次输入的密码不一致。",
        "register.error_default": "注册时发生错误。",
        "modal.title": "服务条款",
        "modal.p1": "欢迎使用 TravelMS。创建账号即表示您同意遵守以下条款。",
        "modal.h1": "1. 服务使用",
        "modal.p2": "TravelMS 致力于为您提供安全的预订平台。",
        "modal.h2": "2. 用户账号",
        "modal.p3": "您有责任维护密码的机密性。",
        "modal.h3": "3. 数据保护",
        "modal.p4": "收集的信息仅用于平台的正常运行。",
        "modal.btn": "我已理解并接受",
...
// Nettoyage de l'ancien token pour éviter les conflits
localStorage.removeItem('token');

// Fonction de gestion multilingue
...
// 2. Gestion de la fenêtre modale des CGU
...
// 3. Fonction Toast pour les notifications élégantes
...
if (registerForm) {
    registerForm.addEventListener('submit', async (e) => {
        ...
        if (password !== confirmPassword) {
            showToast(translations[currentLang]["register.error_match"] || translations.fr["register.error_match"], "error");
            return;
        }
        ...
        try {
            ...
            // Enregistrement optionnel du token si l'API le renvoie directement à l'inscription
            if (data.token) {
            ...
            setTimeout(() => {
                window.location.href = 'login.html'; // Redirection vers la page de connexion ou le dashboard
            }, 1500);
